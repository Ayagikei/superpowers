...
2. **using-git-worktrees** - Activates only when isolation is needed and approved. Detects existing worktrees first, then uses native or git worktree setup when appropriate.
